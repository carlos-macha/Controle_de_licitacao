...
interface ItemLicitacaoDetalheProps {
...
const ItemLicitacaoDetalhe: React.FC<ItemLicitacaoDetalheProps> = ({ data, dataModel, isManutencao = false, validateFields }) => {
...
export default ItemLicitacaoDetalhe;