...
interface LicitacaoEnderecoManutencaoModalProps { }

const LicitacaoEnderecoManutencaoModal: React.FC<LicitacaoEnderecoManutencaoModalProps> = () => {

    const { modalState, modalDispash } = useModalContext() as any;

    const novoEndereco = (): Partial<IModelLicitacao> => ({
        CEP: "",
        LOGRADOURO: "",
        NUMERO: "",
        BAIRRO: "",
    ...
    const [data, setData] = useState<Partial<IModelLicitacao>>(novoEndereco());

    const [validateFields] = useState(
        new ValidateFields()
    );

    const dataModel: InputDataValue<Partial<IModelLicitacao>> = {
        data,
        setData
    };
    ...
    for (const campo of camposObrigatorios) {
        ...
        const valor = data[campo as keyof Partial<IModelLicitacao>] as string;
    ...
    return (
        ...
        <Modal
            id="licitacao-endereco-manutencao-modal"
            className="fade"
            largeType="large"
        >
            ...
            <ModalBody>
                ...
                {modalState?.type === "licitacaoEnderecoManutencaoModal" && (
...
export default LicitacaoEnderecoManutencaoModal;